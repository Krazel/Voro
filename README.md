...
- Efectos reforzados: alcance +15 %, digestión +25 %, rendimiento +12 %, velocidad +15 %, agilidad +30 % y reducción de daño del 12 % por nivel. Los límites evitan inmunidad o velocidad sin control. El impulso inicial multiplica la velocidad por 1,3 durante 0,24 s con recarga de 9 s; sus tres mejoras suben fuerza y duración y reducen la recarga a 7 / 5 / 3 s. Se guarda su recarga.
- Tentáculos cazadores: 1 / 2 / 3 brazos orgánicos animados buscan presas comestibles distintas, se extienden, cierran el agarre y las acercan. Solo tiran después de tocar; la absorción sigue exigiendo el alcance corporal. Sueltan presas al perder tamaño o recibir daño y se limpian al cambiar de etapa o reiniciar.
