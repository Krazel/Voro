...
const entries = [
  ...
  ['pond', natural, 4, 'algae', 'Alga filamentosa', 32, 2.6, 'plant'],
  ['pond', natural, 5, 'leaf', 'Fragmento de hoja', 50, 3.8, 'drift'],
  ['pond', natural, 6, 'shell', 'Microconcha vacía', 85, 8, 'solid'],
  ...
  ['land', natural, 8, 'grass', 'Hierba de la orilla', 65, 4, 'plant'],
  ['land', natural, 9, 'acorn', 'Bellota', 35, 2.6, 'solid'],
  ['land', natural, 10, 'twig', 'Rama caída', 105, 9, 'solid'],
  ['land', natural, 11, 'pebble', 'Guijarro', 45, 3.3, 'solid'],
  ['land', natural, 5, 'leaf', 'Hoja caída', 90, 6, 'drift'],
  ['water', objects, 0, 'kelp', 'Alga marina', 90, 10, 'plant'],
  ['water', objects, 1, 'coral', 'Rama de coral', 45, 4, 'solid'],
