...
export function LivingMenuArt({ journey, pause = false }: { journey: boolean; pause?: boolean }) {
  ...
  useEffect(() => {
    ...
    gl.shaderSource(fragment, `precision mediump float;
      varying vec2 uv; uniform sampler2D art; uniform float t; uniform float journey; uniform float pause;
      void main(){
        vec2 q=uv;
