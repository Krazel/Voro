...
const out='design/journey-d3-2026-09-23';
const browser=await chromium.launch({channel:'msedge',headless:true});
const reports=[];
try {for(const [width,height,lang,pc] of [[887,1774,'es',false],[820,1180,'en',false],[390,844,'es',false],[375,667,'en',false],[1194,834,'es',false],[1280,800,'en',true]]){
 const errors=[];
...
await writeFile(`${out}/checks.json`,JSON.stringify(reports,null,2));console.log('Privacy and completed journey: 6 layouts, EN/ES, manual entry, cancel, silence, confirmed restart passed.');
